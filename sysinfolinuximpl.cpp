...
double SysInfoLinuxImpl::memoryUsed()
{
    ...
    qulonglong totalMemUsed = memInfo.totalram - memInfo.freeram;
    totalMemUsed += memInfo.totalswap - memInfo.freeswap;
    totalMemUsed *= memInfo.mem_unit;

    double percent = (double) totalMemUsed / (double) totalMemory * 100.0;
